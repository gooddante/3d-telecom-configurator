...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Cn,depthTest:!1,depthWrite:!1})}function Vo(){return new Qn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ea(),fragmentShader:`
		...
		`,blending:Cn,depthTest:!1,depthWrite:!1})}function Wo(){return new Qn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ea(),fragmentShader:`
...
`].filter($i).join(`
`)),a=ca(a),a=Qo(a,t),a=ec(a,t),o=ca(o),o=Qo(o,t),o=ec(o,t),a=tc(a),o=tc(o),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(E=`#version 300 es
